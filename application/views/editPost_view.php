...
<br>
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				<h2 class="text-light">UPDATE BLOG POST</h2>
				<div class="row">
					<div class="col">
						<?php echo form_open_multipart("dashboard/updatePost/$posts->Id", ['class'=>'form-horizontal']);?>
						  <fieldset>
						    <div class="form-group ">
						      <label for="">Title</label>
							  <?php echo form_input(['name'=>'title', 'placeholder'=>'Title', 'value'=>
							  set_value('title', $posts->Title), 'class'=>'form-control']); ?>
						    ...
						    <div class="form-group ">
							  ...
							  set_value('description', $posts->Description), 'class'=>'form-control']); ?>
						    ...
						    <br><br>
						    <div class="form-group ">
							  <?php echo form_submit(['name'=>'submit', 'value'=>'UPDATE POST', 'class'=>'btn btn-info mr-2']); ?>
